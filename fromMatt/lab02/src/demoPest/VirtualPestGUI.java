...
/**<CODE>VirtualPestGUI</CODE> provides a graphical user interface for a
* virtual pest.
*@author Tim Wahls
...
public class VirtualPestGUI extends JFrame {

  // the pest that inhabits this GUI
  private VirtualPest thePest;
  ...
  /** Creates a new VirtualPestGUI inhabited by Fred Fish, the default
   * VirtualPest.  Fred's state is explicitly shown.
   */
  public VirtualPestGUI(VirtualPest v) {
      this(v, true);
  }
...
//    gridBagConstraints.gridwidth = 2;
  ...
  public static void main(String args[]) {
    ...
    new VirtualPestGUI(new VirtualPest("Fred", 1), false);
  }
}
